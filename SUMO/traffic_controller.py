...
class BaseTrafficController:
    ...
    def swap2order(self, phase):
        ...
        m_order_1 = np.array(
            [
                1 + 1 * r1g1_swap + 2 * g_swap,
                2 - 1 * r1g1_swap + 2 * g_swap,
                3 + 1 * r1g2_swap - 2 * g_swap,
                4 - 1 * r1g2_swap - 2 * g_swap,
            ],
            dtype=int,
        )
        m_order_2 = np.array(
            [
                5 + 1 * r2g1_swap + 2 * g_swap,
                6 - 1 * r2g1_swap + 2 * g_swap,
                7 + 1 * r2g2_swap - 2 * g_swap,
                8 - 1 * r2g2_swap - 2 * g_swap,
            ],
            dtype=int,
        )
